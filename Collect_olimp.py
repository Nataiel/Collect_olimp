...
def class_table_creater(wb, sheets):
    ...
    columns_width = {
        ...
        'D': 20,  # Отчество
        'E': 10,  # Дом/ Школа
        'F': while_col,  # Предмет 1
        'G': while_col,  # Предмет 2
        'H': while_col,  # Предмет 3
        'I': while_col,  # Предмет 4
        'J': while_col,  # Предмет 5
        'K': while_col,  # Предмет 6
        'L': while_col,  # Предмет 7
        'M': while_col,  # Предмет 8
        'N': while_col,  # Предмет 9
        'O': while_col,  # Предмет 10
        'P': while_col,  # Предмет 11
        'Q': while_col,  # Предмет 12
        'R': while_col,  # Предмет 13
        'S': while_col,  # Предмет 14
        'T': while_col,  # Предмет 15
        'U': while_col,  # Предмет 16
        'V': while_col,  # Предмет 17
        'W': while_col,  # Предмет 18
        'X': while_col,  # Предмет 19
        'Y': while_col,  # Предмет 20
        'Z': while_col,  # Предмет 21
        'AA': while_col,  # Предмет 22
        'AB': while_col,  # Предмет 23
        'AC': while_col  # Предмет 24
    }
